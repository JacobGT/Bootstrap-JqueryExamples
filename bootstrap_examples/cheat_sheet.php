...
<link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <div class="container-fluid d-flex align-items-center">
    <h1 class="d-flex align-items-center fs-4 text-white mb-0">
      <img src="../assets/brand/cyber_dagger.svg" width="38" height="30" class="me-3" alt="Bootstrap">
      Cheatsheet
    </h1>
  </div>
</header>
<aside class="bd-aside sticky-xl-top text-muted align-self-start mb-3 mb-xl-5 px-2">
  <h2 class="h6 pt-4 pb-3 mb-4 border-bottom">Cheatsheet es un documento donde puedes encontrar la amyoría de componentes de Bootstrap. Es muy util para cuando se te olvida algo y quieres saber como implementarlo. Estos archivos incluso te direccionaran a la documentacion por si alguna vez necesitas ayuda. (Por esta misma razón no tradujimos la pagína web y la tratamos de personalizar lo minimo posible).</h2>
  ...
  <section id="content">
    ...
    <article class="my-3" id="typography">
      ...
      <div>
        ...
        <p class="display-1">Display 1: Cyber Dagger</p>
        <p class="display-2">Display 2: Cyber Dagger</p>
        <p class="display-3">Display 3: Cyber Dagger</p>
        <p class="display-4">Display 4: Cyber Dagger</p>
        <p class="display-5">Display 5: Cyber Dagger</p>
        <p class="display-6">Display 6: Cyber Dagger</p>
        </div>

        <div class="bd-example">
        <p class="h1">Heading 1: Cyber Dagger</p>
        <p class="h2">Heading 2: Cyber Dagger</p>
        <p class="h3">Heading 3: Cyber Dagger</p>
        <p class="h4">Heading 4: Cyber Dagger</p>
        <p class="h5">Heading 5: Cyber Dagger</p>
        <p class="h6">Heading 6: Cyber Dagger</p>
        </div>

        <div class="bd-example">
        <p class="lead">
          This is a lead paragraph. It stands out from regular paragraphs. Cyber Dagger
        </p>
        </div>

        <div class="bd-example">
        <p>You can use the mark tag to <mark>highlight</mark> text. <mark>Cyber Dagger</mark></p>
    ...
    <article class="my-3" id="tables">
      ...
      <div>
        ...
        <table class="table table-dark table-borderless">
          ...
          <tr>
            <th scope="row">3</th>
            <td colspan="2">Sammantha Gonzalez</td>
            <td>@samy.gt</td>
          </tr>
          </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
          ...
          <tr>
            <th scope="row">3</th>
            <td colspan="2">Diego Calderon</td>
            <td>@andrescalde32</td>
          </tr>
          </tbody>
        </table>
      ...
      <div>
        ...
        <form class="row g-3">
          <div class="col-md-4">
            ...
            <input type="text" class="form-control is-valid" id="validationServer01" value="Sammy" required>
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control is-valid" id="validationServer02" value="Gonzalez" required>
            <div class="valid-feedback">
              Looks good!
            </div>
          </div>
